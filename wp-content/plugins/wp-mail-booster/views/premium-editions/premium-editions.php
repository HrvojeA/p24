...
*
* @author Tech Banker
* @package wp-mail-booster/views/premium-editions
* @version 2.0
*/
														...
														<div class="gw-go-col gw-go-clean-style14">
															 <div class="gw-go-col-inner">
																	...
																	<ul class="gw-go-body">
																		 ...
																		 <li data-row-index="2">
																				<div class="gw-go-body-cell" style="height: 75px;"><span style="color:#A4CD39;">$</span><span style="font-size:52px;color:#A4CD39;">4.99<br></span><span style="color:#A4CD39;">It's a one time purchase.</span></div>
																		 </li>
														...
														<div class="gw-go-col gw-go-clean-style14">
															 <div class="gw-go-col-inner">
																	...
																	<ul class="gw-go-body">
																		 ...
																		 <li data-row-index="2">
																				<div class="gw-go-body-cell" style="height: 75px;"><span style="color:#A4CD39;">$</span><span style="font-size:52px;color:#A4CD39;">9.99<br></span><span style="color:#A4CD39;">It's a one time purchase.</span></div>
																		 </li>
																		 <li class="gw-go-even" data-row-index="3">
																				<div class="gw-go-body-cell" style="height: 16px;">1 Installation per License</div>
																		 </li>
														...
														<div class="gw-go-col gw-go-clean-style14">
															 <div class="gw-go-col-inner">
																	...
																	<ul class="gw-go-body">
																		 ...
																		 <li data-row-index="2">
																				<div class="gw-go-body-cell" style="height: 75px;"><span style="color:#A4CD39;">$</span><span style="font-size:52px;color:#A4CD39;">39.99<br></span><span style="color:#A4CD39;">It's a one time purchase.</span></div>
																		 </li>
																		 <li class="gw-go-even" data-row-index="3">

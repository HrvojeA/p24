							...
							<div class="form-body">
								...
								<div class="table-top-margin">
									<select name="ux_ddl_email_logs" id="ux_ddl_email_logs" class="custom-bulk-width">
										...
										<option value="delete" style="color:red"><?php echo $mb_email_logs_delete; ?> ( Premium Edition )</option>
									</select>
									<input type="button" class="btn vivid-green" name="ux_btn_apply" id="ux_btn_apply" value="<?php echo $mb_email_logs_apply;?>" onclick="premium_edition_notification_wp_mail_booster()">
								</div>
												...
												<td class="custom-alternative">
													...
													if(isset($value["debug_mode"]))
													{
														...
														<a href="javascript:void(0);">
															<i class="icon-custom-doc tooltips" data-original-title="<?php echo $mb_email_logs_show_outputs ;?>" data-placement="top" onclick="premium_edition_notification_wp_mail_booster()"></i>
														</a> |
														<?php
													}
													?>
													<a href="javascript:void(0);">
														<i class="icon-custom-share-alt tooltips" data-original-title="<?php echo $mb_email_logs_show_details ;?>" data-placement="top" onclick="premium_edition_notification_wp_mail_booster()"></i>
													</a> |
													<a href="javascript:void(0);">
														<i class="icon-custom-trash tooltips" data-original-title="<?php echo $mb_email_logs_delete ;?>" data-placement="top" onclick="premium_edition_notification_wp_mail_booster()"></i>
													</a>
												</td>
											</tr>
											<?php

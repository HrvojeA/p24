...
else
{
	...
	else
	{
		...
		if($flag == "1")
		{
			...
			(
				"parent"=>"wp_mail_booster",
				"id"=>"error_logs_mail_booster",
				"title"=>$mb_error_logs,
				"href"=>admin_url("admin.php?page=mail_booster_error_logs")
			));
			$wp_admin_bar->add_menu(array
			(
				"parent"=>"wp_mail_booster",
				"id"=>"mail_booster_premium_editions",
				"title"=>$mb_premium_edition_label,
				"href"=>admin_url("admin.php?page=mail_booster_premium_editions")
			));
		}
	}
}
